...
const DEFAULT_CDP_URL = process.env.PT_CDP_URL || 'http://localhost:9222';
 ...
 */
export async function getPage(browser, source) {
  // Don't override UA on CDP remote — cloakbrowser sets its own stealth context
  const context = source === 'cdp'
